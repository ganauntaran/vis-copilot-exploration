...
function MyComponent() {
  return (
    <div className="flex justify-center items-center px-16 py-20 h-screen max-md:px-5">
      <div className="flex flex-col justify-center px-4 py-12 mt-72 max-w-full bg-white rounded-md w-[400px] max-md:mt-10">
        <img
          loading="lazy"
          srcSet="https://cdn.builder.io/api/v1/image/assets/TEMP/efb02bea3345c872486d184b34ba45550ef6a5f5889096dca4122aea2aa706f4?apiKey=d9be0c21d3f04234b0773d24d90d90a3&width=100 100w"
