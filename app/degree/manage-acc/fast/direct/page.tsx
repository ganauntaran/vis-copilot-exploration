  ...
  return (
    <div className="flex flex-col justify-center bg-gray-100">
      <div className="flex flex-col w-full max-md:max-w-full">
        ...
        <div className="flex justify-center items-center px-16 py-4 w-full font-semibold text-gray-900 bg-white shadow-sm max-md:px-5 max-md:max-w-full">
          <div className="flex gap-5 justify-between w-full max-w-[1216px] max-md:flex-wrap max-md:max-w-full">
            <div className="my-auto text-2xl leading-6">Pengaturan Akun</div>
            <div className="justify-center px-8 py-2.5 text-sm tracking-normal leading-5 text-center bg-amber-300 rounded-[100px] max-md:px-5">
              Create Account
            </div>
          </div>
        </div>
        <div className="flex justify-center items-center px-16 py-20 w-full text-gray-900 max-md:px-5 max-md:max-w-full">
          <div className="flex flex-col items-center mt-44 mb-32 max-w-full w-[400px] max-md:my-10">
            <img
              loading="lazy"
              srcSet="https://cdn.builder.io/api/v1/image/assets/TEMP/34c11d5fcda6cfa1ae179c870af94b4c0c9ae13f9dfee95f872e257bf59526fe?apiKey=d9be0c21d3f04234b0773d24d90d90a3&width=100 100w, https://cdn.builder.io/api/v1/image/assets/TEMP/34c11d5fcda6cfa1ae179c870af94b4c0c9ae13f9dfee95f872e257bf59526fe?apiKey=d9be0c21d3f04234b0773d24d90d90a3&width=200 200w, https://cdn.builder.io/api/v1/image/assets/TEMP/34c11d5fcda6cfa1ae179c870af94b4c0c9ae13f9dfee95f872e257bf59526fe?apiKey=d9be0c21d3f04234b0773d24d90d90a3&width=400 400w, https://cdn.builder.io/api/v1/image/assets/TEMP/34c11d5fcda6cfa1ae179c870af94b4c0c9ae13f9dfee95f872e257bf59526fe?apiKey=d9be0c21d3f04234b0773d24d90d90a3&width=800 800w, https://cdn.builder.io/api/v1/image/assets/TEMP/34c11d5fcda6cfa1ae179c870af94b4c0c9ae13f9dfee95f872e257bf59526fe?apiKey=d9be0c21d3f04234b0773d24d90d90a3&width=1200 1200w, https://cdn.builder.io/api/v1/image/assets/TEMP/34c11d5fcda6cfa1ae179c870af94b4c0c9ae13f9dfee95f872e257bf59526fe?apiKey=d9be0c21d3f04234b0773d24d90d90a3&width=1600 1600w, https://cdn.builder.io/api/v1/image/assets/TEMP/34c11d5fcda6cfa1ae179c870af94b4c0c9ae13f9dfee95f872e257bf59526fe?apiKey=d9be0c21d3f04234b0773d24d90d90a3&width=2000 2000w, https://cdn.builder.io/api/v1/image/assets/TEMP/34c11d5fcda6cfa1ae179c870af94b4c0c9ae13f9dfee95f872e257bf59526fe?apiKey=d9be0c21d3f04234b0773d24d90d90a3&"
              className="max-w-full aspect-[0.85] w-[136px]"
            />
            <div className="mt-6 text-2xl font-bold leading-7">
              Daftar admin tidak tersedia
            </div>
            <div className="self-stretch mt-6 text-base text-center text-gray-500">
              Saat ini tidak ada akun yang tersedia di sistem. Anda dapat
              menambahkan akun baru dengan mengklik tombol &quot;Create New
              Account&quot;.
            </div>
            <div className="justify-center px-8 py-2.5 mt-6 text-sm font-semibold tracking-normal leading-5 text-center bg-amber-300 rounded-[100px] max-md:px-5">
              Create Account
            </div>
          </div>
        </div>
