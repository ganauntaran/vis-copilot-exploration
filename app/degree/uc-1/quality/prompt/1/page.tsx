...
const Button: React.FC<ButtonProps> = ({ children, className, onClick }) => {
  return (
    <button
      className={`justify-center px-8 py-2.5 text-sm font-semibold tracking-normal leading-5 text-center bg-amber-300 rounded-[100px] max-md:px-5 ${className}`}
      onClick={onClick}
    >
      {children}
    </button>
  ...
  return (
    <div className="flex flex-col items-center mt-44 mb-32 max-w-full w-[400px] max-md:my-10">
      ...
      <p className="self-stretch mt-6 text-base text-center text-gray-500">
        Saat ini tidak ada akun yang tersedia di sistem. Anda dapat menambahkan
        akun baru dengan mengklik tombol &quot;Create New Account&quot;.
      </p>
...
const Header: React.FC = () => {
  return (
    <header className="flex justify-center items-center px-16 py-4 w-full font-semibold text-gray-900 bg-white shadow-sm max-md:px-5 max-md:max-w-full">
