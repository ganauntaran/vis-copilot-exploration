...
function RoleSelect({ role }: RoleSelectProps) {
  return (
    <div className="flex flex-col mt-4 max-md:max-w-full">
      <div className="font-semibold tracking-normal text-gray-500 max-md:max-w-full">Role</div>
      <div className="flex gap-5 justify-between px-3 py-2.5 mt-1 text-gray-900 bg-white rounded-md border border-gray-300 border-solid max-md:flex-wrap max-md:max-w-full">
        <div>{role}</div>
        <ChevronDownIcon className="shrink-0 w-5 aspect-square" />
      </div>
    </div>
  )
}
...
function ReadOnlyField({ label, value }: ReadOnlyFieldProps) {
  return (
    <div className="flex flex-col mt-4 max-md:max-w-full">
      <div className="font-semibold tracking-normal text-gray-500 max-md:max-w-full">{label}</div>
...
function NipField({ nip }: NipFieldProps) {
  return (
    <div className="flex flex-col max-md:max-w-full">
      <div className="font-semibold tracking-normal text-gray-500 max-md:max-w-full">NIP</div>
      ...
      <div className="flex flex-col w-full max-md:max-w-full">
          ...
          <div className="flex gap-5 justify-between px-8 py-5 mx-5 max-md:flex-wrap max-md:px-5 max-md:mr-2.5 max-md:max-w-full">
            <div className="flex gap-5 justify-between">
              <div className="flex justify-center items-center my-auto">
                <Image loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/5b3cad048cf2d8db79a1cc204010da24ac17a653e28fd118f5fb2301a1a65490?apiKey=d9be0c21d3f04234b0773d24d90d90a3&" alt="" width={68} height={37} />
              </div>
            ...
            <div className="flex gap-5 justify-between rounded-3xl">
              ...
              <Image loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/72ac572355657ddc4027f6990d0a024b0a109a71e4f22633536df0dda685baa6?apiKey=d9be0c21d3f04234b0773d24d90d90a3&" alt="Profile" width={40} height={40} />
            </div>
          </div>
        </header>
        ...
        <main className="flex justify-center items-center px-16 py-10 w-full text-sm leading-5 max-md:px-5 max-md:max-w-full">
          <div className="flex flex-col max-w-full w-[594px]">
            <NipField nip="1998121112391024" />
            {fields.map(({ label, value }) => (
              <ReadOnlyField key={label} label={label} value={value} />
            ))}
            <RoleSelect role="Supervisor Cabang" />
